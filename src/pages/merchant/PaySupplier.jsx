// =======================================================================
// FILE: src/pages/merchant/PaySupplier.jsx (EDITED)
// =======================================================================
import React, { useEffect } from 'react';
import { useDispatch, useSelector } from 'react-redux';
import Card from '../../components/ui/Card';
import { fetchUnpaidDeliveries, payWithMpesa } from '../../features/PaymentSlice.jsx';
                    ...
                    <tbody>
                        {unpaidDeliveries && unpaidDeliveries.map(delivery => (
                            <tr key={delivery.id} className="border-b">
                                ...
                                <td className="p-3">{delivery.quantity_received}</td>
                                ...
                                <td className="p-3">
                                    ...
                                    >
                                        {status === 'loading' ? 'Paying...' : 'Pay with M-Pesa'}
                                    </button>
                                </td>
                            </tr>
                        ))}
